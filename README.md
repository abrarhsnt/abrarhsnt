...
- Worked on manuscript preparation, experiments, and model evaluation



## Publications

- [**Interpretable Heart Disease Prediction via a Weighted Ensemble Model**](https://arxiv.org/abs/2511.01947)  
  Weighted ensemble framework with SHAP and surrogate decision trees.

- [**Interpretability of Machine Learning Models in Medical Image Analysis**](https://www.techrxiv.org/users/815368/articles/1274881-interpretability-of-machine-learning-models-in-medical-image-analysis-a-study-using-the-rsna-pneumonia-dataset?commit=53a9313cad62ee6687c992fb7f0841ee8c11d02a)  
  Explainability-focused study using the RSNA Pneumonia Dataset.

- [**A Color Vision Approach Considering Reflection Coefficient Based on Autoencoder Techniques**](https://dspace.bracu.ac.bd/xmlui/handle/10361/17125)  
